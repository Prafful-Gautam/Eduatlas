...
//=============================================INSTITUTE API=============================================================
  ...
  getInstitutes():Observable<any[]>{
    return this.http.get<any[]>('http://139.59.26.154:5000/institute/all', this.httpOptions).pipe(
      tap(),
 ...
 getInstitute(id:string):Observable<any>{
   const url = `http://139.59.26.154:5000/institute/oneInstitute/${id}`;
  ...
  addInstitute(institute) {
    ...
    return this.http.post<{message: string}>('http://139.59.26.154:5000/institute/addInstitute', postData, this.httpOptions).pipe(
      tap(data => console.log(data)),
      catchError(this.handleError)
    );
  }
  updateInstitute(id:string,institute:any):Observable<any>{
    const url = `http://139.59.26.154:5000/institute/updateInstitute/${id}`;
 ...
 deleteInstitute(id:string):Observable<void>{
   const url = 'http://139.59.26.154:5000/institute/'+ id;
...
getStudents(instituteId):Observable<any[]>{
  const url = `http://139.59.26.154:5000/institute/student/all/${instituteId}`;
 ...
 getStudent(params):Observable<any>{
   ...
   return this.http.get<any>('http://139.59.26.154:5000/institute/student/',
   ...
   addStudent(student):Observable<{message: String}>{
    ...
    return this.http.post<{message: string}>('http://139.59.26.154:5000/institute/student/add', data, this.httpOptions)
    .pipe(
      tap( data => console.log(data)),
      catchError(this.handleError)
      );
  ...
  updateStudent(params, student: any):Observable<any>{
    ...
    return this.http.put<any>('http://139.59.26.154:5000/institute/student/', data, 
   ...
   return this.http.delete<void>('http://139.59.26.154:5000/institute/student/',
   {params:param,headers: this.headers}).pipe(
     catchError(this.handleError)
     );
 }
...
//============================================COURSE API============================================================
 ...
 getCourses(id):Observable<any[]>{
   return this.http.get<any[]>(`http://139.59.26.154:5000/institute/course/all/${id}`, this.httpOptions).pipe(
  tap((data)=>console.log(data)),
  catchError(this.handleError)
     );
 }
  addCourse( id:string, course: any):Observable<any>{
    return this.http.post<any>(`http://139.59.26.154:5000/institute/course/addCourse/${id}`, course, this.httpOptions).pipe(
      tap(data => console.log(data)),
      catchError(this.handleError)
      );
  }
  ...
  getCourse(params):Observable<any>{
   ...
   return this.http.get<any>('http://139.59.26.154:5000/institute/course/one',
   {params: params, headers: this.headers}).pipe(
     catchError(this.handleError)
     );
  }
  updateCourse(params,course):Observable<any>{
    ...
    return this.http.patch<any>('http://139.59.26.154:5000/institute/course/',course,
    {params: params, headers: this.headers}).pipe(
      map(()=>course),
      catchError(this.handleError)
      );
  ...
  deleteCourse(param):Observable<void>{
    ...
    return this.http.delete<void>('http://139.59.26.154:5000/institute/course/course/',
    {params: param, headers: this.headers}).pipe(
      catchError(this.handleError)
            );
  }
...
//============================================BATCHES API============================================================
  ...
  getBatches(branchId: string): Observable<any[]>{
    return this.http.get<any[]>(`http://139.59.26.154:5000/institute/course/batches/${branchId}`, this.httpOptions).pipe(
  tap(data => console.log(data)),
  catchError(this.handleError)
    );
  }
  getBatch(params):Observable<any>{
    ...
    return this.http.get<any>('http://139.59.26.154:5000/institute/course/batch/', 
    {params: params, headers: this.headers}).pipe(
      catchError(this.handleError)
      );
  }
  addBatch(branchId: string, batch: any): Observable<batchData>{
    ...
    return this.http.post<batchData>(`http://139.59.26.154:5000/institute/course/addBatch/${branchId}`, batch, this.httpOptions).pipe(
      tap(data => console.log(data)),
      catchError(this.handleError)
      )
  }
  deleteBatch(params):Observable<void>{
    ...
    return this.http.delete<void>('http://139.59.26.154:5000/institute/course/batch/', 
    {params: params, headers: this.headers}).pipe(
catchError(this.handleError)
      );
  }
  updateBatch(params,batch:batchData):Observable<any>{
    ...
    return this.http.patch<any>('http://139.59.26.154:5000/institute/course/batch/',batch,
    {params: params, headers: this.headers}).pipe(
      map(()=>batch),
      catchError(this.handleError)
      );
...
//============================================DISCOUNT API============================================================
 ...
 getDiscounts(id: string):Observable<any[]>{
    return this.http.get<any[]>(`http://139.59.26.154:5000/institute/course/discounts/${id}`,this.httpOptions).pipe(
  tap(data => console.log(data)),
  catchError(this.handleError)
      );
  }
  getDiscount(params): Observable<any>{
    return this.http.get<any>('http://139.59.26.154:5000/institute/course/discount',
    {params: params, headers: this.headers}).pipe(
catchError(this.handleError)
      );
  }
  ...
  addDiscount(id:string,discount:any):Observable<any>{
    ...
    return this.http.post<any>(`http://139.59.26.154:5000/institute/course/addDiscount/${id}`,discount,this.httpOptions).pipe(
      tap(data => console.log(data)),
      catchError(this.handleError)
      );
  }
    ...
    return this.http.delete<void>('http://139.59.26.154:5000/institute/course/discount/',
    {params: params, headers: this.headers}).pipe(
      catchError(this.handleError)
            );
  }
    ...
    return this.http.patch<any>('http://139.59.26.154:5000/institute/course/discount/',discount,
    {params: params, headers: this.headers}).pipe(
      map(()=>discount),
      catchError(this.handleError)
      );
...
//============================================RECEIPT API============================================================
    ...
    return this.http.get<any>(`http://139.59.26.154:5000/institute/course/reciept/${id}`, this.httpOptions).pipe(
  ...
  addReceipt(id:string, receipt: any):Observable<receiptData>{
    receipt.id = null;
    return this.http.post<any>(`http://139.59.26.154:5000/institute/course/addReciept/${id}`, receipt, this.httpOptions).pipe(
      tap(data => console.log(data)),
      catchError(this.handleError)
      );
  }
    updateReceipt(id:string, reciept):Observable<any>{
    const url = `http://139.59.26.154:5000/institute/course/reciept/${id}`;
    ...
    return this.http.delete<void>(`http://139.59.26.154:5000/institute/course/reciept/${id}`,this.httpOptions).pipe(
    catchError(this.handleError)
      );
  }
